...
/*
   CHUNITHM CUSTOM IO API. TAKEN FROM https://gitea.tendokyu.moe/Dniel97/segatools/src/branch/develop/chuniio/chuniio.h
...
EXTERN_C DLLEXPORT uint16_t chuni_io_get_api_version(void);
...
EXTERN_C DLLEXPORT HRESULT chuni_io_jvs_init(void);
...
EXTERN_C DLLEXPORT void chuni_io_jvs_poll(uint8_t* opbtn, uint8_t* beams);
...
EXTERN_C DLLEXPORT void chuni_io_jvs_read_coin_counter(uint16_t* total);
...
EXTERN_C DLLEXPORT HRESULT chuni_io_slider_init(void);
...
EXTERN_C DLLEXPORT void chuni_io_slider_start(chuni_io_slider_callback_t callback);
...
EXTERN_C DLLEXPORT void chuni_io_slider_stop(void);
...
EXTERN_C DLLEXPORT void chuni_io_slider_set_leds(const uint8_t* rgb);
...
EXTERN_C DLLEXPORT HRESULT chuni_io_led_init(void);
...
EXTERN_C DLLEXPORT void chuni_io_led_set_colors(uint8_t board, uint8_t* rgb);
